...
const Banner = () => {
    ...
    return (
      <div>
        <div className="min-h-[25vh] uppercase hover:text-[#d366f5] flex justify-center items-center bg-white text-center  text-[#44dbae] font-bold text-[50px]">
      About
  </div>
  ...
  <div className='pt-7 md:pt-3 w-full sm:w-[85%] mx-auto' data-aos="fade-right">
      ...
      <div className="hover:bg-[#f8f5f5] bg-white shadow-xl mx-4 my-4  rounded-lg overflow-hidden flex p-5 space-y-2 ">
       ...
       <h1 className="font-serif font-bold text-[19px] md:text-[25px] text-[#44dbae] capitalize underline underline-offset-4">Our Vision:</h1>
      ...
      <div className="hover:bg-[#f8f5f5] bg-white shadow-lg mx-4 my-4  rounded-lg overflow-hidden flex flex-col p-5 space-y-2 ">
       ...
       <h1 className="font-serif font-bold text-[19px] md:text-[25px] text-[#44dbae] capitalize underline underline-offset-4">Mission Statement:</h1>
      ...
      <div className="hover:bg-[#f8f5f5] bg-white shadow-lg mx-4 my-4  rounded-lg overflow-hidden flex flex-col p-5 space-y-2 ">
       <div className='flex justify-between px-1'>
       <h1 className="font-serif font-bold text-[19px] md:text-[25px] text-[#44dbae] capitalize underline underline-offset-4">Company Values:</h1>
    ...
    <section className=" bg-gradient-to-r from-pink-100  to-[#f0d4f8] text-center  text-[#a065b3] py-10 my-[50px]">
    ...
    <section className="bg-white py-10 w-[90%] sm:w-[85%] mx-auto">
      <div className="container mx-auto">
        <h2 className="text-3xl font-bold mb-8 text-[#44dbae]">Our Products</h2>
        <ProductCard
          number={1}
  ...
  const ProductCard = ({ number, title, description }) => {
    return (
      <div className="mb-8">
        <h3 className="text-xl font-bold mb-2 text-[#606d6d]">{number}. {title}</h3>
