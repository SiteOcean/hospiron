...
const FlexPageCards = () => {
  return (
    <div className='mt-[50px] mb-[50px] w-full' data-aos="fade-right">
      <h1 className='text-center font-bold text-[30px] py-1 text-[#a33cc2] '>HealthTech Solutions</h1>
      <div  
      ...
      <div className="hover:scale-105 duration-500 bg-white shadow-xl mx-4 my-4  rounded-lg overflow-hidden flex flex-col p-5 space-y-2 ">
       ...
       <h1 className="font-serif font-bold text-[19px] md:text-[21px] text-[#a33cc2] capitalize underline underline-offset-4">Precision Imaging</h1>
      ...
      <div className="hover:scale-105 duration-500 bg-white shadow-xl mx-3 my-3 sm:m-0  rounded-lg overflow-hidden flex flex-col p-5 space-y-2 ">
       <div className='flex justify-between px-1'>
       <h1 className="font-serif font-bold text-[19px] md:text-[21px] text-[#a33cc2] capitalize underline underline-offset-4">Smart Pumps</h1>
      ...
      <div className="hover:scale-105 duration-500 bg-white shadow-xl mx-4 my-4  rounded-lg overflow-hidden flex flex-col p-5 space-y-2 ">
       <div className='flex justify-between px-1'>
       <h1 className="font-serif font-bold text-[19px] md:text-[21px] text-[#a33cc2] capitalize underline underline-offset-4">Rapid Diagnostics</h1>
