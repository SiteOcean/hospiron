...
const FlexSection = () => {
  return (
    ...
    <h1 className='mt-[100px] mb-3 text-center font-bold text-[23px] px-3 sm:text-[30px] text-[#4cacec]'>Advancing Healthcare Technologies for Better Patient Care</h1>
   <div className=' md:pb-12 space-y-12'>
     ...
     <div className="flex flex-col-reverse sm:flex-row justify-center">
      <div className="w-full lg:w-1/2 px-4 py-4 flex flex-col justify-center align-middle">
        ...
        <span className="font-bold block mb-2 text-[#4f5a5a]">Cutting-Edge Imaging Excellence: Redefining Diagnostic Precision</span>
    ...
    <div className="flex flex-col-reverse sm:flex-row-reverse justify-center">
      ...
      <div className="w-full lg:w-1/2 px-4 py-4 flex flex-col justify-center align-middle">
        ...
        <p className="text-stone-500 font-serif  sm:w-[70%] mx-auto mb-4">
        <span className="font-bold block mb-2 text-[#4f5a5a]">Vital Signs Revolution: Seamless Patient Monitoring Solutions</span>
    ...
    <div className="flex flex-col-reverse sm:flex-row justify-center ">
      <div className="w-full lg:w-1/2 px-4 py-4 flex flex-col justify-center align-middle">
        ...
        <p className="text-stone-500 font-serif sm:w-[70%] mx-auto  mb-4">
        <span className="font-bold block mb-2 text-[#4f5a5a]">Surgical Precision Redefined: The Future of Robotic-Assisted Procedures</span>
